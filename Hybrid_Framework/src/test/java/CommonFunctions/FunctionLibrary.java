...
public class FunctionLibrary {
	...
	public static void capturestock(WebDriver driver, String Locator_Type, String Locator_Value) throws Throwable
	{
		...
		FileWriter fw = new FileWriter("./CapturedData/stocknumber.txt");
	...
	public static void stockTable(WebDriver driver)throws Throwable
	{
		...
		FileReader fr = new FileReader("./CapturedData/stocknumber.txt");
	...
	public static void capturesupplier(WebDriver driver, String Locator_Type, String Locator_value)throws Throwable
	{
		...
		FileWriter fw = new FileWriter("./CapturedData/suppliernumber.txt");
		BufferedWriter bw = new BufferedWriter(fw);
	...
	{
		FileReader fr = new FileReader("./CapturedData/suppliernumber.txt");
		BufferedReader br = new BufferedReader(fr);
		String Exp_Data =br.readLine();
		if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
			driver.findElement(By.xpath(conpro.getProperty("search-panel"))).click();
		...
		driver.findElement(By.xpath(conpro.getProperty("search-button"))).click();
		Thread.sleep(2000);
		String Act_Data = driver.findElement(By.xpath("//table[@class='table ewTable']/tbody/tr[1]/td8]/div/span/span")).getText();
		Reporter.log(Exp_Data+"  "+Act_Data,true);
		try {
